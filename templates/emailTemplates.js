...
export function getValidationEmailTemplate(userName, url) {
  const bodyContent = `
      ...
      `;
  return { subject: "Validación de Cuenta - Investiga Sanidad", html: buildEmail({ title: "Validación de Cuenta - Investiga Sanidad", bodyContent }) };
}
...
export function getWelcomeEmailTemplate(userName, loginUrl) {
  const bodyContent = `
      ...
      `;
  return { subject: "Te has registrado correctamente en Investiga Sanidad", html: buildEmail({ title: "Bienvenido a Investiga Sanidad", bodyContent }) };
}
...
export function getPasswordResetEmailTemplate(userName, resetUrl) {
  const bodyContent = `
      ...
      `;
  return { subject: "Recuperación de contraseña - Investiga Sanidad", html: buildEmail({ title: "Recuperación de contraseña - Investiga Sanidad", bodyContent }) };
}
...
export function getEditionPaymentEmailTemplate(userName, editionId, editionUrl) {
  const bodyContent = `
      ...
      `;
  return { subject: "Pago recibido correctamente - Investiga Sanidad", html: buildEmail({ title: "Pago recibido - Investiga Sanidad", bodyContent }) };
}
...
export function getBookCreationEmailTemplate(authorName, bookTitle, sectionUrl) {
  const bodyContent = `
      ...
      `;
  return { subject: "Has creado tu libro en Investiga Sanidad", html: buildEmail({ title: "Libro creado - Investiga Sanidad", bodyContent }) };
}
export function getCoauthorInvitationEmailTemplate(coauthorName, bookTitle, sectionUrl) {
  ...
  `;
  return buildEmail({ subject, html });
}

export function getBookClosedEmailTemplate(recipientName, bookTitle) {
...
export function getBookPublishedEmailTemplate(recipientName, bookTitle, downloadUrl, certificatesUrl) {
...
export function getChapterSubmissionEmailTemplate(authorName, chapterTitle, contextLabel) {
...
export function getChapterAcceptedEmailTemplate(authorName, chapterTitle, contextLabel) {
...
export function getChapterRejectedEmailTemplate(authorName, chapterTitle, reason, contextLabel) {
...
export function getEditionPublishedEmailTemplate(recipientName, editionName, certificatesUrl, bookUrl, chaptersUrl) {
